...
<body style="font-family: Consolas, 'Courier New', monospace; display: flex; flex-direction: column; align-items: center;">
    ...
    <div style="display: flex; justify-content: center;">
        <form:form modelAttribute="admin" style="font-size: 25px; text-decoration: none">
            <table>
                <tr>
                    <td>Admin Email:</td>
                    <td><form:input path="email" size="30"/> <font color="red"><form:errors path="email"/></font>
                    </td>
                </tr>

                <tr>
                    <td>Password:</td>
                    <td><form:password path="pass" size="30"/> <font color="red"><form:errors path="pass"/></font>
                    </td>
                </tr>
    ...
    <div style="display: flex; justify-content: center; margin-top: 20px;">
        <img src="https://learningforlife.pixel-online.org/common/img/login.jpg" alt="Login Button">
    </div>
    <br>
